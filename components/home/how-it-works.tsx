    ...
    <section className="relative overflow-x-clip" id="how-it-works">
      ...
      <div className="mx-auto max-w-[1600px] px-6 sm:px-10 lg:px-20">
        <div className="grid lg:grid-cols-2 lg:gap-16">
          ...
          <div className="pt-16 text-center lg:sticky lg:top-0 lg:flex lg:h-dvh lg:flex-col lg:justify-center lg:pt-0 lg:text-left">            <h2 className="mt-3 text-3xl font-semibold sm:text-4xl text-center lg:text-left">
          ...
          <div className="flex flex-col gap-24 py-16 lg:gap-0 lg:py-[6vh]">
            {steps.map((s, i) => (
              <motion.div
                key={s.number}
                id={`step-visual-${i}`}
                ...
                viewport={{ amount: 0.5 }}
                className={"flex items-center " + (i === 0 || i === steps.length - 1 ? "lg:min-h-[70vh]" : "lg:min-h-[85vh]")}
              >
                <motion.div
